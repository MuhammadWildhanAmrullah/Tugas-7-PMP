        ...
        CustomScrollView (
          slivers: <Widget>[
            ...
            SliverAppBar (
              ...
              Container(
                child: Row(
                  children:<Widget>[Image.asset('assets/Logo.png',fit: BoxFit.contain,
                    height: 60,),
                    Text('Inaklug'),
                  ],
                ),
              ...
              delegate: SliverChildListDelegate (
                [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                        'Membangun Sumber Daya Indonesia yang mempunyai daya tinggi, tangguh secara internasional untuk menghadapi persaingan di era globalisasi serta membangun karakter pemimpin Indonesia masa depan yang tangguh, mandiri, dan profesional'
                            '.'),
                  ),
                  Divider(),
                  Stack(
                    children: <Widget>[
                      Image.asset('assets/Gambar3.png'),
                    ],
                  ),
                  ListTile(
                    title: Text(
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text("MUALA BY GALERIA JAKARTA, CILANDAK TOWN SQUARE, LT.BASMENT.",
